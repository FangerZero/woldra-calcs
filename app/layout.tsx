...
import { PaymentsOutlined, AccountBalanceWalletOutlined } from '@mui/icons-material';
    ...
    <html lang="en">
      <body className={inter.className}>
        <div className="m-2 mt-4 flex justify-center px-4 lg:px-24">
          ...
          <Link href="/bill-splitter" className="rounded border-black border-2 p-2 m-1"><PaymentsOutlined className="mx-2"/> Bill Splitter</Link>
          <Link href="/budget-rater" className="rounded border-black border-2 p-2 m-1"><AccountBalanceWalletOutlined className="mx-2"/>Budget Rater</Link>
        </div>
      <div className="m-2 mt-4 flex justify-center px-4 lg:px-24">
      {children}
      </div>
